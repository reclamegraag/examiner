    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-sm perspective-1000">
          ...
          >
            <div
              className="absolute inset-0 bg-card border-2 border-border-bold rounded-3xl p-6 flex flex-col items-center justify-center shadow-brutal"
            ...
            >
              ...
              <p className="text-sm text-muted mt-4 font-medium bg-background px-3 py-1 rounded-lg border border-border">Tik om te draaien</p>
            </div>

            <div
              className="absolute inset-0 bg-accent-light border-2 border-accent rounded-3xl p-6 flex flex-col items-center justify-center shadow-brutal-accent"
